...
//su.opencode.DomHelper = function() {
var DomHelper = function() {
	...
	return {
		...
		createEl: function(tag, id, cls, text) {
			...
			if (cls)
			{
//				var cssClass = su.opencode.DomHelper.getClass(cls);
		...
		createScriptEl: function(src) {
			var scriptElement = document.createElement(su.opencode.DomHelper.SCRIPT_TAG);
//			scriptElement.setAttribute(su.opencode.DomHelper.TYPE_ATTRIBUTE, 'text/javascript');
//			scriptElement.setAttribute(su.opencode.DomHelper.SRC_ATTRIBUTE, src);
//			scriptElement.setAttribute(su.opencode.DomHelper.CHARSET_ATTRIBUTE, 'UTF-8');
...
//			var imgElement = document.createElement(su.opencode.DomHelper.IMG_TAG);
//			imgElement.setAttribute(su.opencode.DomHelper.SRC_ATTRIBUTE, src);
//			imgElement.setAttribute(su.opencode.DomHelper.ALT_ATTRIBUTE, alt || '');
...
//			var cssLink = document.createElement(su.opencode.DomHelper.LINK_TAG);
//			cssLink.setAttribute(su.opencode.DomHelper.REL_ATTRIBUTE, 'stylesheet');
//			cssLink.setAttribute(su.opencode.DomHelper.TYPE_ATTRIBUTE, 'text/css');
//			cssLink.setAttribute(su.opencode.DomHelper.HREF_ATTRIBUTE, cssUrl);
...
//			var headElement = document.getElementsByTagName(su.opencode.DomHelper.HEAD_TAG)[0];
		...
		removeChildrenHierarchy: function(element) {
			while (element.hasChildNodes()) {
//				su.opencode.DomHelper.removeChildrenHierarchy(element.lastChild);
